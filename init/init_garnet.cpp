...
void vendor_load_properties() {
    ...
    if (region == "IN") {
        ...
        if (sku == "garnet") {
            brand = "Redmi";
            description = "garnet_in-user 14 UKQ1.231003.002 V816.0.8.0.UNRINXM release-keys";
            fingerprint = "Redmi/garnet_in/garnet:14/UKQ1.231003.002/V816.0.8.0.UNRINXM/release-keys";
            marketname = "Redmi Note 13 Pro 5G";
            model = "2312DRA50I";
        } else {
            brand = "POCO";
            description = "garnetp_in-user 14 UKQ1.231003.002 V816.0.8.0.UNRINXM release-keys";
        ...
        if (sku == "garnet") {
            brand = "Redmi";
            description = "garnet_global-user 15 AQ3A.240912.001 OS2.0.6.0.VNREUXM release-keys";
            fingerprint = "Redmi/garnet_global/garnet:15/AQ3A.240912.001/OS2.0.6.0.VNREUXM:user/release-keys";
            marketname = "Redmi Note 13 Pro 5G";
            model = "2312DRA50G";
        } else {
            brand = "POCO";
            description = "garnetp_global-user 15 AQ3A.240912.001 OS2.0.6.0.VNREUXM release-keys";
            fingerprint = "POCO/garnetp_global/garnet:15/AQ3A.240912.001/OS2.0.6.0.VNREUXM:user/release-keys";
            marketname = "POCO X6 5G";
            model = "23122PCD1G";
        }
    } else if (region == "CN") {
        ...
        mod_device = "garnet";
        brand = "Redmi";
        description = "garnet-user 14 UKQ1.231003.002 V816.0.7.0.UNRCNXM release-keys";
        fingerprint = "Redmi/garnet/garnet:14/UKQ1.231003.002/V816.0.7.0.UNRCNXM:user/release-keys";
