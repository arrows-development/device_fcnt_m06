...
void vendor_load_properties() {
    ...
    if (region == "IN") {
        ...
        if (sku == "garnet") {
            brand = "Redmi";
            description = "garnet_global-user 15 AQ3A.240912.001 OS2.0.10.0.VNRMIXM release-keys";
            fingerprint = "Redmi/garnet_global/garnet:15/AQ3A.240912.001/OS2.0.10.0.VNRMIXM:user/release-keys";
            marketname = "Redmi Note 13 Pro 5G";
            model = "2312DRA50G";
        } else {
            brand = "POCO";
            description = "garnetp_global-user 15 AQ3A.240912.001 OS2.0.10.0.VNRMIXM release-keys";
